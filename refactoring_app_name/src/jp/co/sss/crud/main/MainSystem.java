	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, SQLException, ParseException {
		...
		do {
			...
			case 3:
				...
				String deptIdSearch = br.readLine();

				// 検索機能の呼出
				DBController.findByDeptId(deptIdSearch);
				break;
			...
			case 4:
				...
				String deptIdRegist = br.readLine();

				// 登録機能の呼出
				DBController.insert(empName, Seibetsu, birthday, deptIdRegist);
				break;
			...
			case 5:
				...
				// 更新する値を入力する
				String empIdUpdateStr = br.readLine();

				// 更新機能の呼出
				DBController.update(empIdUpdateStr);
			...
			case 6:
				...
				// 削除する値を入力する
				String empIdDeleteStr = br.readLine();

				// 削除機能の呼出
				DBController.delete(empIdDeleteStr);
				break;
